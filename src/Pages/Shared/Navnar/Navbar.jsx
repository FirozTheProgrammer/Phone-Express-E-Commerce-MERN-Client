...
const Navbar = () => {
  ...
  const handelLogOut = () => {
    logOut().then(toast.success("Successfully Log Out")).catch();
  };
    ...
    <>
      ...
      <li className="font-bold text-lg">
        <NavLink
          to={"/mycart"}
          className={({ isActive, isPending }) =>
            isActive ? "border-black border-b-" : isPending ? "pending " : ""
          }
        >
          CART
        </NavLink>
        ...
        <div className="navbar-end">
          {user ? (
            <div className="dropdown dropdown-end">
              ...
              <ul
                tabIndex={0}
                className="mt-3 z-[1] p-3 shadow  menu-sm dropdown-content bg-base-100 rounded-box w-52 flex flex-col"
              >
                <li>
                ...
                <li className="self-end">
                  <Link
                    ...
                    className="bg-black text-white px-4 my-"
                  >
                    Logout
                  </Link>
                </li>
